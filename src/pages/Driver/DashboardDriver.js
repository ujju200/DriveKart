			...
			<div>
				...
				<Container className="mt-3" style={{ marginBottom: "60px" }}>
					<p style={{ marginTop: "50px", fontSize: "25px" }}>
						List of dealers who booked you, All the relevant
						information of the dealers is provided below :-
					</p>

					{this.state.dealers.length === 0 ? (
						<h1>
							Sorry You haven&apos;t been booked by any dealer
						</h1>
					) : (
